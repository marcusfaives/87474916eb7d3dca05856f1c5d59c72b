<div class="tab-content" id="pills-tabContent">
        ...
        <form class="formFiltro" method="POST" action="api.php" class="row g-3">
            <div class="row g-3 mt-3">
                ...
                <div class="col-md-2">
                    ...
                    <input value="13" required type="number" class="form-control" id="gtincodauxiliar" name="gtincodauxiliar">
                </div>
                <div class="col-md-2">
                    <label for="gtincodauxiliartrib" class="form-label">GTIN Cod Auxiliar Trib</label>
                    <input value="13" required type="number" class="form-control" id="gtincodauxiliartrib" name="gtincodauxiliartrib">
                </div>
                <div class="col-md-2">
                    <label for="gtincodauxiliar2" class="form-label">GTIN Código Auxiliar 2</label>
                    <input value="14" required type="number" class="form-control" id="gtincodauxiliar2" name="gtincodauxiliar2">
                </div>
                <div class="col-md-2">
                    <label for="temrepos" class="form-label">Tempo Reposição</label>
                    <input value="" required type="text" class="form-control r" id="temrepos" name="temrepos">
                </div>
                <div class="col-md-2">
                    <label for="aceitavendafracao" class="form-label">Aceita Venda Fração</label>
                    <select required type="text" id="aceitavendafracao" class="form-select" name="aceitavendafracao">
        ...
        <form class="formFiltro" method="POST" action="api.php" class="row g-3">
            <div class="row g-3 mt-3">
                <div class="col-md-2">
                    ...
                    <input value="" required type="text" class="form-control r" id="codepto" name="codepto">
                </div>
                <div class="col-md-2">
                    <label for="codsec" class="form-label">Código Seção</label>
                    <input value="" required type="text" class="form-control r" id="codsec" name="codsec">
                </div>
                <div class="col-md-2">
                    <label for="codcategoria" class="form-label">Código Categoria</label>
                    <input value="" required type="text" class="form-control r" id="codcategoria" name="codcategoria">
                </div>
                <div class="col-md-2">
    ...
    <div class="tab-pane fade d-none" id="logistica" role="tabpanel" aria-labelledby="logistica-tab">
        <form class="formFiltro" method="POST" action="api.php" class="row g-3">
            <div class="row g-3 mt-3">
                <div class="col-md-2">
    ...
    <div class="tab-pane fade d-none" id="outros" role="tabpanel" aria-labelledby="outros-tab">
        <form class="formFiltro" method="POST" action="api.php" class="row g-3">
            <div class="row g-3 mt-3">
            <div class="col-md-2">
